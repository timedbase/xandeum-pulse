...
import { useClusterNodes, useNetworkStats, useClusterInfo, useRefreshData } from '@/hooks/useRpcQuery';
...
const Index = () => {
  const { data: nodes, isLoading: nodesLoading, error: nodesError, refetch: refetchNodes } = useClusterNodes(true);
  const { data: stats, isLoading: statsLoading, error: statsError } = useNetworkStats(true);
  const { data: clusterInfo, isLoading: clusterLoading, error: clusterError } = useClusterInfo(true);
